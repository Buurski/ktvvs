...
- `renovering-af-badevaerelse-01.jpg` — Renovering af badeværelse
- `renovering-af-badevaerelse-02.jpg` — Renovering af badeværelse
- `renovering-af-badevaerelse-03.jpeg` — Renovering af badeværelse
- `renovering-af-badevaerelse-04.jpeg` — Renovering af badeværelse
- `renovering-af-badevaerelse-05.jpg` — Renovering af badeværelse
- `renovering-af-badevaerelse-06.jpg` — Renovering af badeværelse
- `renovering-af-badevaerelse-07.jpg` — Renovering af badeværelse
- `vvs-renovering-bad-i-kaelder.png` — VVS – Renovering af bad i kælder

## Privat — varmepumper / jordvarme
- `enfamiliehus-jordvarme.jpeg` — Enfamiliehus – Jordvarme
- `enfamiliehus-vildbjerg-varmepumpe.jpeg` — Enfamiliehus, Vildbjerg (varmepumpe)

## Privat — blikkenslager / tag
- `enfamiliehus-blikkenslager.jpeg` — Enfamiliehus (blikkenslager)
- `blikkenslager-villa-vildbjerg.jpg` — Blikkenslager, villa i Vildbjerg
- `enfamiliehus-vildbjerg-blikkenslager.jpeg` — Enfamiliehus, Vildbjerg (blikkenslager)
- `enfamiliehus-herning-blikkenslager-01.jpg` — Enfamiliehus, Herning (blikkenslager)
- `enfamiliehus-herning-blikkenslager-02.jpg` — Enfamiliehus, Herning (blikkenslager)
- `enfamiliehus-vildbjerg-blikkenslager-02.jpg` — Enfamiliehus, Vildbjerg (blikkenslager)
- `enfamiliehus-vanloese-blikkenslager.jpg` — Enfamiliehus, Vanløse (blikkenslager)

## Privat — øvrige
- `enfamiliehus-vildbjerg-01.jpeg` — Enfamiliehus, Vildbjerg (VVS)
